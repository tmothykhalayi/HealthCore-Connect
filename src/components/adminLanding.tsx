import { FiUsers, FiCalendar, FiFileText, FiDollarSign, FiPieChart, FiActivity, FiUser, FiShoppingCart, FiPieChart as FiPieChartAlt } from 'react-icons/fi';
      ...
      <div className="mt-12 bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-purple-50 p-4 rounded-lg text-center">
            <p className="text-sm text-purple-600 mb-1">Pending Prescriptions</p>
